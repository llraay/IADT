...
def make_loss(cfg, num_classes):    # modified by gu
    ...
    feat_dim = 768
    arc_criterion = ArcFace(in_features=feat_dim,out_features=num_classes)  # center loss
    ...
    if sampler == 'softmax':
        ...
        def loss_func(feat, target, target_cam, i2tscore = None):
    ...
    return loss_func, arc_criterion
