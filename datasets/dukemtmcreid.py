...
class DukeMTMCreID(BaseImageDataset):
    ...
    # cameras: 8
    """
    dataset_dir = '/data3/shangrui/newsg2/Dukemtmc/DukeMTMC-reID'
    # dataset_dir = '/data3/shangrui/newsg2/datasets/dukemtmc/dukemtmc'
    # dataset_dir = '/data3/shangrui/datasets/dukemtmc'
